...
analysis we will use the continuous outcome approach like the original authors.
The null hypothesis was defined as no difference in efficacy of the treatment
...
We thank Angelika Stefan and František Bartoš for valuable comments on drafts of
