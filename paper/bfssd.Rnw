...
\anonymize{\url{https://doi.org/10.5281/zenodo.XXXXXX}}. We used the statistical
programming language \Sexpr{R.Version()[["version.string"]]} for analyses
\citep{R} along with the \texttt{BFDA} \citep{Schoenbrodt2019}, \texttt{lamW}
\citep{Adler2015}, \texttt{xtable} \citep{Dahl2019}, and \texttt{knitr}
\citep{Xie2024} packages.
